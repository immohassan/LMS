...
<body class="bg-slate-400">
    <h1 class="text-center mt-44 text-4xl font-semibold">User Accounts</h1>
    <br>
    <button class= "bg-blue-600 text-white p-2.5 flex mx-auto rounded mt-3" ><a href="dashboard.php">Go back</a></button>
    <br>
<form method="post" action="users.php" class="w-1/2 mx-auto mb-44 shadow-2xl bg-slate-600 p-12 rounded-xl">
